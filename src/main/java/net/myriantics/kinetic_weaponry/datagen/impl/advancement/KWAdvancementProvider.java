...
public class KWAdvancementProvider extends MyrrorAdvancementSubProvider {
    ...
    protected void generate() {
        ...
        AdvancementHolder wearKineticRetentionModule = addTask(revaulting, "wear_kinetic_retention_module", KWItems.KINETIC_RETENTION_BACKTANK, CriteriaTriggers.INVENTORY_CHANGED.createCriterion(InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(KWItemTags.KINETIC_RETENTION_MODULES)).triggerInstance()));
