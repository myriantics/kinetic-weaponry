...
public class KineticWeaponryItems {
    ...
    public static final DeferredItem<KineticRetentionModuleBlockItem> KINETIC_RETENTION_MODULE_BLOCK_ITEM =
            ITEMS.register("kinetic_retention_module",
                    () -> new KineticRetentionModuleBlockItem(KineticWeaponryBlocks.KINETIC_RETENTION_MODULE.get(), new Item.Properties()
                            .component(KineticWeaponryDataComponents.KINETIC_CHARGE.value(), new KineticChargeDataComponent(0))
    ...
    public static final DeferredItem<KineticChargingBusBlockItem> KINETIC_CHARGING_BUS_BLOCK_ITEM =
            ITEMS.register("kinetic_charging_bus",
                    () -> new KineticChargingBusBlockItem(KineticWeaponryBlocks.KINETIC_CHARGING_BUS.get(), new Item.Properties()
                            .component(KineticWeaponryDataComponents.KINETIC_CHARGE, new KineticChargeDataComponent(0))
                            .rarity(Rarity.EPIC)
                    )
            );
